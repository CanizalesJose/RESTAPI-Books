...
INSERT INTO `users` VALUES ('admin','$2b$10$/H59qNhJRDbVWtA.DIU7f.zNpA1yWWfGcEM3g4w2zL1kF/Ge0X1vi','admin','123-123-1234','correo@correo.com',0),('usuario','$2a$10$gg0gsMs9mqq3w061FuN7HuJjyumVgwQtsiXBtg/.IpFwqXixRQvcK','client','686-321-4321','client@email.com',0);

INSERT INTO `loans` VALUES ('E3a6Gy1z7XEpc1','admin','2024-10-26','2024-11-02'),('r6J5uPNV3hT8D','admin','2024-10-26','2024-11-02'),('rjD','admin','2024-10-26','2024-11-02'),('u','admin','2024-10-26','2024-11-02'),('utC','admin','2024-10-26','2024-11-02'),('VV','admin','2024-10-26','2024-11-02'),('zztMfI7JD0','admin','2024-10-26','2024-11-02');
